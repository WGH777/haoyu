...
// Segmented component removed — using el-segmented directly
...
<template>
  <LayPanel>
    <div class="p-5">
      ...
      <el-segmented
        class="select-none"
        :modelValue="themeMode === 'system' ? 'system' : dataTheme ? 'dark' : 'light'"
        :options="[
      ...
      <span v-if="useAppStoreHook().getViewportWidth > 1280">
        ...
        <el-segmented
          ...
          :modelValue="isNumber(settings.stretch) ? 'fixed' : 'auto'"
          :options="[
