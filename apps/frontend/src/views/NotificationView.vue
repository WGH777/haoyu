...
const tagType = (type: string) => {
  const map: Record<string, string> = {
    ...
    ORDER_DISPUTED: 'warning',
    DISPUTE_RESOLVED: 'success',
    DEADLINE_WARNING: 'warning',
    PROVIDER_UNRESPONSIVE: 'danger',
    AUTO_CONFIRMED: 'info',
    REQUEST_RESPONDED: 'primary',
    SERVICE_SUBMITTED: 'primary',
    RISK_ALERT: 'danger',
...
const typeLabel = (type: string) => {
  const map: Record<string, string> = {
    REQUEST_RESPONDED: '已被接单',
    SERVICE_STARTED: '服务开始',
    SERVICE_SUBMITTED: '已提交',
    SERVICE_COMPLETED: '已完成',
    ORDER_DISPUTED: '争议',
    REFUND_CREATED: '退款',
    SETTLEMENT_CREATED: '结算',
    RISK_ALERT: '风控',
    SYSTEM: '系统',
    PAYMENT_RECEIVED: '支付',
    AUTO_CONFIRMED: '自动确认',
    ...
    DEADLINE_WARNING: '即将超时',
    PROVIDER_UNRESPONSIVE: '服务者超时',
  }
